...
plt.plot(tau_vals, result_estimate_PRFM)
plt.plot(tau_vals, result_estimate_NPRFM)
plt.plot(tau_vals, result_real_M)
plt.ylabel('OPTIMAL')
plt.show()
# %% KNN
...
result_real_M = long_run_cost_realM_v(100, tau_vals)
...
plt.plot(tau_vals, result_estimate_NPRFM)
plt.plot(tau_vals, result_estimate_PKNNM)
plt.plot(tau_vals, result_estimate_NPKNNM)
plt.ylabel('OPTIMAL')
plt.show()
...
plt.plot(tau_vals, result_estimate_PGNBM, color='c')
plt.plot(tau_vals, result_estimate_NPGNBM, color='r')
...
plt.plot(tau_vals, result_real_M)
plt.plot(tau_vals, result_estimate_NPSVMM)
plt.plot(tau_vals, result_estimate_PSVMM)
plt.ylabel('OPTIMAL')
plt.show()
# %% LDA
...
plt.plot(tau_vals, result_real_M)
plt.plot(tau_vals, result_estimate_NPLDAM)
plt.plot(tau_vals, result_estimate_PLDAM)
plt.ylabel('OPTIMAL')
plt.show()
# %% Decission Tree
...
plt.plot(tau_vals, result_real_M)
plt.plot(tau_vals, result_estimate_PDTM)
plt.plot(tau_vals, result_estimate_NPDTM)
plt.ylabel('OPTIMAL')
plt.show()
